...
class UpCloud(VideoExtractor):
    _sources_base_url = "https://dokicloud.one/ajax/embed-4/getSources?id="
    headers =  {
    ...
    def extract(self,embed: str) -> VideoContainer:
        ...
        r: requests.Response = requests.get(UpCloud._sources_base_url + embed,headers=UpCloud.headers)
